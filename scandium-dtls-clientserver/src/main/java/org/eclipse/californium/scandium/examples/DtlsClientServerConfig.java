 ...
 * around with when testing Scandium DTLS clients/servers.
 */
public class DtlsClientServerConfig {
	...
	@Parameter(names = "-port", required = false, description = "The port to listen to for servers, and the port to connect to for clients")
	...
	@Parameter(names = "-client", required = false, description = "Runs as a client or server")
	...
	@Parameter(names = "-clientAuth", required = false, description = "Defines the authentication method for servers.")
